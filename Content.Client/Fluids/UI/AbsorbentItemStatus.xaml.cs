...
namespace Content.Client.Fluids.UI
{
    ...
    public sealed partial class AbsorbentItemStatus : SplitBar
    {
        ...
        protected override void FrameUpdate(FrameEventArgs args)
        {
            ...
            {
                FrameUpdateAbsorbent(absorbent);
                return;
            }
            if (_entManager.TryGetComponent<PaintAbsorbentComponent>(_uid,out var paintAbsorbent))
            {
                FrameUpdateAbsorbent(paintAbsorbent);
            }
        }
        private void FrameUpdateAbsorbent(IAbsorbentProgress absorbent)
        {
